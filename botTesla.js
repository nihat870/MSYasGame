...
bot.action('start', ctx=>{
    ctx.deleteMessage()
    ctx.replyWithMarkdown(`*Salam,Mən Təxmin oyun botuyam, Vaxtınızı əyləncəli keçirmək üçün\nMəni qrupa əlavə et\n**Əsas əmrlərin siyahısı üçün /help*
        `,{
        reply_markup:{
            inline_keyboard:[
